		...
		<%for i=lbound(LINGUE_CODICI) to ubound(LINGUE_CODICI)%>
			<tr>
				...
				<td class="content" colspan="3">
					...
					<input type="text" class="text" name="tft_sdr_titolo_<%= LINGUE_CODICI(i) %>" value="<%= rs("sdr_titolo_"& LINGUE_CODICI(i)) %>" maxlength="250" size="75">
				<% 	if LINGUE_CODICI(i) = LINGUA_ITALIANO then
						response.write "(*)"
					end if %>
				</td>
			</tr>

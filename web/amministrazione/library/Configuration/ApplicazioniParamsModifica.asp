...
dim conn, rs, sql,ID, connContent
...
dicitura.puls_new = "INDIETRO;DATI APPLICAZIONE;TABELLE DATI"
dicitura.link_new = "Applicazioni.asp;ApplicazioniMod.asp?ID=" & request("ID") & ";ApplicazioniTabelle.asp?ID=" & ID
...
<div id="content">
	...
	<table cellspacing="1" cellpadding="0" class="tabella_madre">
		...
		<%  sql = " SELECT * FROM (tb_siti_descrittori_raggruppamenti g"& _
				  ...
				  " WHERE rsd_sito_id = "& ID
			CALL DesFormConn(connContent, conn, sql & " ORDER BY sdr_ordine, sdr_id", _
						 "tb_siti_descrittori", "sid_id", "sid_nome_it", "sid_tipo", "sid_unita_it", "", "rsd_valore_", "rsd_memo_", _

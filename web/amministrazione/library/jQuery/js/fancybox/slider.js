 ...
 * http://css-tricks.com/moving-boxes/
 ...
 (Giacomo) url: http://webdesignandsuch.com/posts/fancymoves/js/slider.js
...
(function($){
	$.movingBoxes = function(el, options){
		...
		base.completed = function(num, flag){
			...
			base.$panels.eq(base.curPanel-1).addClass(base.options.currentPanel); // Giacomo: correzione 21/08/2012

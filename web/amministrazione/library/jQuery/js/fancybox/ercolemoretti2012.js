 ...
 * FancyMoves - MovingBoxes demo script
 ...
 url: http://webdesignandsuch.com/posts/fancymoves/demo/demo.js
 */
...
$(function(){
	...
	$('#slider-one').movingBoxes({
		...
		panelWidth   : 0.7,     // current panel width adjusted to 70% of overall width
		reducedSize  : .4,    // non-current panel size: 80% of panel size
		buildNav     : false,

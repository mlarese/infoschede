...
<div id="content">
	...
	<input type="hidden" name="tfn_sid_personalizzato" value="1">
	<table cellspacing="1" cellpadding="0" class="tabella_madre">
		...
		<%for i=lbound(Application("LINGUE")) to ubound(Application("LINGUE"))%>
			<tr>
				...
				<td class="content" colspan="3">
					...
					<input type="text" class="text" name="tft_sid_nome_<%= Application("LINGUE")(i) %>" value="<%= request.form("tft_sid_nome_"& Application("LINGUE")(i)) %>" maxlength="255" size="75">
        ...
        <%for i=lbound(Application("LINGUE")) to ubound(Application("LINGUE"))%>
			<tr>
				...
				<td class="content" colspan="3">
					<img src="../grafica/flag_<%= Application("LINGUE")(i) %>.jpg" width="26" height="15" alt="" border="0">
					<input type="text" class="text" name="tft_sid_unita_<%= Application("LINGUE")(i) %>" value="<%= request.form("tft_sid_unita_"& Application("LINGUE")(i)) %>" maxlength="255" size="20">
				</td>
			</tr>
		<%next %>
		<tr>

...
'--------------------------------------------------------
sezione_testata = "Gestione alert - configurazione - nuova" %>
<!--#INCLUDE FILE="../library/Intestazione_Ridotta.asp" -->
<%'------------------------------------------------------%>

<div id="content_ridotto">
<form action="" method="post" id="form1" name="form1">
	<input type="hidden" name="tfn_rse_evento_id" value="<%= request("ALERT_ID") %>">
	<table cellspacing="1" cellpadding="0" class="tabella_madre" style="width: 695px;">
		<caption>Inserimento nuova configurazione</caption>
		<% 	sql = "SELECT sev_multisito FROM tb_siti_eventi WHERE sev_id = "& cIntero(request("ALERT_ID"))
		...
		<tr>
			...
			<td class="content" colspan="3">
				<%	sql = "SELECT * FROM tb_webs ORDER BY id_webs"
					CALL dropDown(conn, sql, "id_webs", "nome_webs", "tfn_rse_web_id", request.form("tfn_rse_web_id"), false, " style=""width:100%;""", LINGUA_ITALIANO) %>
			</td>
		</tr>
		<% 	end if %>
		...
		<tr>
			...
			<td class="content" colspan="3">
				...
				<%= Chk(request.form("chk_rse_email_abilitato") <> "") %>>
			</td>
		</tr>
		<tr>
			<td class="label">invio all'amministratore:</td>
			<td class="content">
				<input type="checkbox" class="checkbox" name="chk_rse_email_admin_invio" value="1" <%= Chk(request.form("chk_rse_email_admin_invio") <> "") %>>
			</td>
			<td class="label">invio agli utenti:</td>
			<td class="content">
				<input type="checkbox" class="checkbox" name="chk_rse_email_utenti_invio" value="1" <%= Chk(request.form("chk_rse_email_utenti_invio") <> "") %>>
			</td>
		</tr>
		<tr>
			...
			<td class="content" colspan="3">
				<%	sql = " SELECT *, (admin_cognome "& SQL_concat(conn) &" ' ' "& SQL_concat(conn) & SQL_IfIsNull(conn, "admin_nome", "''") &") AS NOME"& _
					...
					CALL dropDown(conn, sql, "id_admin", "NOME", "tfn_rse_email_admin_id", request.form("tfn_rse_email_admin_id"), true, " style=""width:100%;""", LINGUA_ITALIANO) %>
			</td>
		</tr>
			...
			<td class="content" colspan="3">
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="left">
					<tr>
						...
						<td>
							<input type="text" class="text" size="90" maxlength="250" name="tft_rse_email_oggetto_<%= Application("LINGUE")(i) %>" value="<%= request.form("tft_rse_email_oggetto_"& application("LINGUE")(i)) %>">
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			...
			<td class="content" colspan="3">
				<% CALL DropDownPages(NULL, "form1", "429", 0, "tfn_rse_email_paginaId", request("tfn_rse_email_paginaId"), true, false) %>
				(*)
			</td>
		</tr>
		...
		<tr>
			...
			<td class="content" colspan="3">
				...
				<%= Chk(request.form("chk_rse_fax_abilitato") <> "") %>>
			</td>
		</tr>
		<tr>
			<td class="label">invio all'amministratore:</td>
			<td class="content">
				<input type="checkbox" class="checkbox" name="chk_rse_fax_admin_invio" value="1" <%= Chk(request.form("chk_rse_fax_admin_invio") <> "") %>>
			</td>
			<td class="label">invio agli utenti:</td>
			<td class="content">
				<input type="checkbox" class="checkbox" name="chk_rse_fax_utenti_invio" value="1" <%= Chk(request.form("chk_rse_fax_utenti_invio") <> "") %>>
			</td>
		</tr>
		<tr>
			<td class="label" style="white-space: nowrap;">amministratore mittente:</td>
			<td class="content" colspan="3">
				<%	sql = " SELECT *, (admin_cognome "& SQL_concat(conn) &" ' ' "& SQL_concat(conn) & SQL_IfIsNull(conn, "admin_nome", "''") &") AS NOME"& _
						  " FROM tb_admin ORDER BY admin_cognome"
					CALL dropDown(conn, sql, "id_admin", "NOME", "tfn_rse_fax_admin_id", request.form("tfn_rse_fax_admin_id"), true, " style=""width:100%;""", LINGUA_ITALIANO) %>
			</td>
		</tr>
		<%for i=lbound(Application("LINGUE")) to ubound(Application("LINGUE"))%>
		<tr>
			...
			<td class="content" colspan="3">
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="left">
					<tr>
						<td width="5%" valign="top"><img src="../grafica/flag_<%= Application("LINGUE")(i) %>.jpg" width="26" height="15" alt="" border="0"></td>
						<td>
							<input type="text" class="text" size="90" maxlength="250" name="tft_rse_fax_oggetto_<%= Application("LINGUE")(i) %>" value="<%= request.form("tft_rse_fax_oggetto_"& application("LINGUE")(i)) %>">
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td class="label">pagina da inviare:</td>
			<td class="content" colspan="3">
				<% CALL DropDownPages(NULL, "form1", "429", 0, "tfn_rse_fax_paginaId", request("tfn_rse_fax_paginaId"), true, false) %>
				(*)
			</td>
		</tr>
		...
		<tr>
			...
			<td class="content" colspan="3">
				...
				<%= Chk(request.form("chk_rse_sms_abilitato") <> "") %>>
			</td>
		</tr>
		<tr>
			<td class="label">invio all'amministratore:</td>
			<td class="content">
				<input type="checkbox" class="checkbox" name="chk_rse_sms_admin_invio" value="1" <%= Chk(request.form("chk_rse_sms_admin_invio") <> "") %>>
			</td>
			<td class="label">invio agli utenti:</td>
			<td class="content">
				<input type="checkbox" class="checkbox" name="chk_rse_sms_utenti_invio" value="1" <%= Chk(request.form("chk_rse_sms_utenti_invio") <> "") %>>
			</td>
		</tr>
		<tr>
			<td class="label" style="white-space: nowrap;">amministratore mittente:</td>
			<td class="content" colspan="3">
				<%	sql = " SELECT *, (admin_cognome "& SQL_concat(conn) &" ' ' "& SQL_concat(conn) & SQL_IfIsNull(conn, "admin_nome", "''") &") AS NOME"& _
						  " FROM tb_admin ORDER BY admin_cognome"
					CALL dropDown(conn, sql, "id_admin", "NOME", "tfn_rse_sms_admin_id", request.form("tfn_rse_sms_admin_id"), true, " style=""width:100%;""", LINGUA_ITALIANO) %>
			</td>
		</tr>
		<%for i=lbound(Application("LINGUE")) to ubound(Application("LINGUE"))%>
		<tr>
			...
			<td class="content" colspan="3">
				<table width="95%" border="0" cellspacing="0" cellpadding="0" align="left">
					<tr>
						<td width="5%" valign="top"><img src="../grafica/flag_<%= Application("LINGUE")(i) %>.jpg" width="26" height="15" alt="" border="0"></td>
						<td>
							<input type="text" class="text" size="90" maxlength="160" name="tft_rse_sms_testo_<%= Application("LINGUE")(i) %>" value="<%= request.form("tft_rse_sms_testo_"& application("LINGUE")(i)) %>">
						</td>
					</tr>
				</table>
			</td>
...
Sub WriteDestinatari(sezione, tipo) %>
		...
		<tr>
			...
			<td class="content" colspan="3">
				<% CALL WriteContactPicker_Input(conn, NULL, "", "", "form1", sezione &"_contatti", request.form(sezione &"_contatti"), tipo, true, false, false, "")  %>
			</td>
		</tr>
		<tr>
			<td class="label">amministratori:</td>
			<td class="content" colspan="3">
				<% CALL WriteAdminPicker_Input(conn, NULL, "", "form1", sezione &"_admin", request.form(sezione &"_admin"), tipo, true, false, false, "")  %>
			</td>
		</tr>
<%
End Sub

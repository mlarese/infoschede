...
if request("salva")<>"" then
	CALL ComunicazioniNew_Wizard_Session_AddField(cIntero(request("type")), "newsletter_lingua", request.form("lingua"))
	%>
...
'--------------------------------------------------------
sezione_testata = "Gestione lingua di spedizione della newsletter" %>

...
<!--#include file="../Tools_Rubriche.asp"-->
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
	  		<tr>
	  			<td style="text-align:right; padding-right:10px;">
					<a href="../default.asp" class="menu" title="esci dall'import dati e torna al NEXT-com" <%= ACTIVE_STATUS %>> torna al NEXT-com</a>
				</td>
	  		</tr>
		</table>
	</caption>

...
dicitura.sezione = "Gruppi caratteristiche tecniche- modifica"
dicitura.puls_new = "INDIETRO"
dicitura.link_new = "CaratteristicheGruppi.asp"
dicitura.scrivi_con_sottosez() 

sql = "SELECT * FROM gtb_carattech_raggruppamenti WHERE ctr_ID=" & cIntero(request("ID"))
...
<div id="content">
	...
	<table cellspacing="1" cellpadding="0" class="tabella_madre">
		<caption>Modifica dati gruppo di caratteristiche tecniche</caption>

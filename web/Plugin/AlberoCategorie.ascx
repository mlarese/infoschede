<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AlberoCategorie.ascx.cs" Inherits="Plugin_AlberoCategorie" %>
...
<cc1:NextList ID="Albero" runat="server" CssClass="categorie" OnItemDataBound="Albero_ItemDataBound">
    <ItemTemplate>        

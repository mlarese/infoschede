	...
	<table cellspacing="1" cellpadding="0" class="tabella_madre">
		...
		<% 	end if %>
			<td class="content" colspan="3">
				...
				<input type="text" class="text" name="tft_sid_nome_<%= LINGUE_CODICI(i) %>" value="<%= rs("sid_nome_"& LINGUE_CODICI(i)) %>" maxlength="255" size="75">
        ...
        <%for i=lbound(LINGUE_CODICI) to ubound(LINGUE_CODICI)%>
			<tr>
				...
				<td class="content" colspan="3">
					<img src="../../grafica/flag_<%= LINGUE_CODICI(i) %>.jpg" width="26" height="15" alt="" border="0">
					<input type="text" class="text" name="tft_sid_unita_<%= LINGUE_CODICI(i) %>" value="<%= rs("sid_unita_"& LINGUE_CODICI(i)) %>" maxlength="255" size="20">
				</td>
			</tr>
		<%next %>
		<tr>

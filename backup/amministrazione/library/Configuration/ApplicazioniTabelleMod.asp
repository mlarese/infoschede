	...
	<form action="" method="post" id="form1" name="form1">
		...
		<table cellspacing="1" cellpadding="0" class="tabella_madre">
			...
			<tr>
				...
				<td class="content">
					<input type="text" class="text" name="tft_tab_name" value="<%= rs("tab_name") %>" maxlength="255" style="width:50%;" readonly>
					(*)
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="content">
					<select name="tfn_tab_db_tipo">
						<option value="0" <%= IIF(rs("tab_db_tipo") = "0", "selected", "") %>>Tutti i DBMS</option>
						<option value="1" <%= IIF(rs("tab_db_tipo") = "1", "selected", "") %>>Access</option>
						<option value="2" <%= IIF(rs("tab_db_tipo") = "2", "selected", "") %>>SQL Server</option>
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="content">
					...
					<input type="text" class="text" name="tft_tab_field_codice_<%= LINGUE_CODICI(i) %>" value="<%= rs("tab_field_codice_"& LINGUE_CODICI(i)) %>" maxlength="255" style="width:89.8%;">
				</td>
			</tr>
			<%next %>
			<%for i=lbound(LINGUE_CODICI) to ubound(LINGUE_CODICI)%>
			<tr>
				...
				<td class="content">
					<img src="../../grafica/flag_<%= LINGUE_CODICI(i) %>.jpg" width="26" height="15" alt="" border="0">
					<input type="text" class="text" name="tft_tab_field_titolo_<%= LINGUE_CODICI(i) %>" value="<%= rs("tab_field_titolo_"& LINGUE_CODICI(i)) %>" maxlength="255" style="width:89.8%;">
			...
			<tr>
				...
				<td class="content">
					...
					<input type="text" class="text" name="tft_tab_field_titolo_alt_<%= LINGUE_CODICI(i) %>" value="<%= rs("tab_field_titolo_alt_"& LINGUE_CODICI(i)) %>" maxlength="255" style="width:89.8%;">
				</td>
			</tr>
			<%next %>
			<%for i=lbound(LINGUE_CODICI) to ubound(LINGUE_CODICI)%>
			<tr>
				...
				<td class="content">
					<img src="../../grafica/flag_<%= LINGUE_CODICI(i) %>.jpg" width="26" height="15" alt="" border="0">
					<input type="text" class="text" name="tft_tab_field_url_<%= LINGUE_CODICI(i) %>" value="<%= rs("tab_field_url_"& LINGUE_CODICI(i)) %>" maxlength="255" style="width:89.8%;">
				</td>
			</tr>
			<%next %>
			<tr>
			...
			<tr>
				...
				<td class="content">
					<img src="../../grafica/flag_<%= LINGUE_CODICI(i) %>.jpg" width="26" height="15" alt="" border="0">
					<input type="text" class="text" name="tft_tab_field_descrizione_<%= LINGUE_CODICI(i) %>" value="<%= rs("tab_field_descrizione_"& LINGUE_CODICI(i)) %>" maxlength="255" style="width:89.8%;">
				</td>
			</tr>
			<%next %>
			<tr>
			...
			<tr>
				...
				<td class="content">
					<img src="../../grafica/flag_<%= LINGUE_CODICI(i) %>.jpg" width="26" height="15" alt="" border="0" style="vertical-align: top;">
					<textarea name="tft_tab_field_meta_keywords_<%= LINGUE_CODICI(i) %>" style="width:94.5%;" rows="2"><%= rs("tab_field_meta_keywords_"& LINGUE_CODICI(i)) %></textarea>
				</td>
			</tr>
			<%next
			for i=lbound(LINGUE_CODICI) to ubound(LINGUE_CODICI)%>
			<tr>
				...
				<td class="content">
					<img src="../../grafica/flag_<%= LINGUE_CODICI(i) %>.jpg" width="26" height="15" alt="" border="0" style="vertical-align: top;">
					<textarea name="tft_tab_field_meta_description_<%= LINGUE_CODICI(i) %>" style="width:94.5%;" rows="2"><%= rs("tab_field_meta_description_"& LINGUE_CODICI(i)) %></textarea>
				</td>
			</tr>
			<%next %>
			<tr>

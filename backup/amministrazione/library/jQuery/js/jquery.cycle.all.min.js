...
if (opts.setTopAndLeft) {
	$slides.hide().css({position:'absolute',top:0,left:0}).each(function(i){var z=first?i>=first?els.length-(i-first):first-i:els.length-i;$(this).css('z-index',z)}); }
else {
	$slides.hide().css({position:'absolute'}).each(function(i){var z=first?i>=first?els.length-(i-first):first-i:els.length-i;$(this).css('z-index',z)}); }
...
var fn=function(){$n.animate(opts.animIn,speedIn,easeIn,cb)};$l.animate(opts.animOut,speedOut,easeOut,function(){if(opts.cssAfter)$l.css(opts.cssAfter);if(!opts.sync)fn();});if(opts.sync)fn();};$.fn.cycle.transitions={fade:function($cont,$slides,opts){$slides.not(':eq('+opts.currSlide+')').css('opacity',0);opts.before.push(function(curr,next,opts){$.fn.cycle.commonReset(curr,next,opts);opts.cssBefore.opacity=0;});opts.animIn={opacity:1};opts.animOut={opacity:0}; 
//Giacomo, 10/09/2013 - modifica perchè se usato questo plugin assieme al resizeImage non voglio che mi resetti il posizionamento delle immagini
if (opts.setTopAndLeft) {
	opts.cssBefore={top:0,left:0}; }
}};
$.fn.cycle.ver=function(){return ver;};$.fn.cycle.defaults={
setTopAndLeft: true, //Giacomo, 10/09/2013 - parametro aggiunto da me

...
dim Classe
	...
	Classe.Requested_Fields_List	= "tft_scc_nome"
	Classe.Checkbox_Fields_List 	= ""
	Classe.Page_Ins_Form			= ""
	Classe.Page_Mod_Form			= ""
	Classe.Next_Page				= ""	'impostata nella gestione delle relazioni
	Classe.Next_Page_ID				= FALSE
	Classe.Table_Name				= "gtb_scontiQ_classi"
	Classe.id_Field					= "scc_id"
...
Sub Gestione_Relazioni_record(conn, rs, ID)
	...
	if request("salva")<>"" then
		Classe.Next_Page = "ScontiQMod.asp?ID="& ID
	else
		Classe.Next_Page = "ScontiQ.asp"
	end if
end Sub

				...
				<td class="content">
					<table cellspacing="0" cellpadding="0">
						<tr>
							...
							<td>
								<% CALL WriteFilePicker_Input(Application("AZ_ID"), "images", "form1", "tft_ct_unita_" & Application("LINGUE")(i), request.form("tft_ct_unita_" & Application("LINGUE")(i)), "width:430px;", FALSE) %>		
							</td>
						</tr>
					</table>
				</td>

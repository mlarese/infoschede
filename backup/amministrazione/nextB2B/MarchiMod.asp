...
<div id="content">
	...
	<table cellspacing="1" cellpadding="0" class="tabella_madre">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="right" style="font-size: 1px;">
						<a class="button" href="?ID=<%= request("ID") %>&goto=PREVIOUS" title="marchio precedente" <%= ACTIVE_STATUS %>>
							&lt;&lt; PRECEDENTE
						</a>
						&nbsp;
						<a class="button" href="?ID=<%= request("ID") %>&goto=NEXT" title="marchio successivo" <%= ACTIVE_STATUS %>>
							SUCCESSIVO &gt;&gt;
						</a>
					</td>
				</tr>
		...
		<tr>
			...
			<td class="content">
				<input type="radio" class="checkbox" value="1" name="tfn_mar_generica" <%= chk(rs("mar_generica")) %>>
				si
				<input type="radio" class="checkbox" value="0" name="tfn_mar_generica" <%= chk(not rs("mar_generica")) %>>
				no
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="content">
				<% CALL WriteFilePicker_Input(Application("AZ_ID"), "images", "form1", "tft_mar_logo", rs("mar_logo"), "", FALSE) %>
			</td>
		</tr>
		<tr>

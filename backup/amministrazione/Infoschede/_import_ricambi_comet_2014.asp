...
ID_CATEGORIA = 1280 'Ricambi - comet 2014
ID_MARCA = 566 'comet
...
<div id="content">
<%
sql = " select Codice, Nome, Descrizione, [Listino 2014], [Qta min] from _2014_listino_comet "
...
<% while not s_rs.eof %>
	<table cellspacing="1" cellpadding="0" class="tabella_madre" style="border-bottom:1px">
		...
		if d_rs.eof then
			...
			d_rs("art_cod_alt") = ""
			d_rs("art_nome_it") = Trim(s_rs("Nome"))
			d_rs("art_descr_riassunto_it") = Trim(s_rs("Descrizione"))

	...
	<table cellspacing="1" cellpadding="0" class="tabella_madre">
		...
		<tr>
			...
			<td class="content" colspan="3">
				<input type="text" class="text" name="tft_admin_cognome" value="<%= rs("admin_cognome") %>" maxlength="250" size="70">
				(*)
			</td>
		</tr>
		<tr>
			...
			<td class="content" colspan="3">
				<input type="text" class="text" name="tft_admin_nome" value="<%= rs("admin_nome") %>" maxlength="250" size="70">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="content" colspan="2">
				<input type="text" class="text" name="tft_admin_email_newsletter" value="<%= rs("admin_email_newsletter") %>" maxlength="50" size="50">
		...
		<tr>
			<td colspan="4">
				<% CALL write_permessi(conn, rsp, true, request("ID"), 3) %>
			</td>
		</tr>

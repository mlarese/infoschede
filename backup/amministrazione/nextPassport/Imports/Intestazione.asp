...
<!--#include file="../../Nextcom/Tools_Rubriche.asp"-->
<!--#include file="Tools_Import.asp"-->
<%
'mette filtro: solo utente NEXT-AIM puo' entrare qui dentro
if uCase(Session("PASS_ADMIN")) <> "NEXTAIM" then
	response.redirect "../default.asp"
end if
%>
<html>
<head>
	<title>Import dati NEXT-com</title>
...
<table width="740" cellspacing="0" cellpadding="0" border="0">
	<caption style="border:0px;">
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
	  		<tr>
	  			<td style="text-align:right; padding-right:10px;">
					<a href="../default.asp" class="menu" title="esci dall'import dati e torna al NEXT-Passport" <%= ACTIVE_STATUS %>> torna al NEXT-Passport</a>
				</td>
	  		</tr>
		</table>
	</caption>
  	...
  	<tr>
		<td style="background-image: url(../../grafica/barra_intestazione.jpg);" class="barra_menu">
